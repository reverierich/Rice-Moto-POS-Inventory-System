"""
Orders View (Kitchen Display System) for RiceMoto POS.
Displays active order queue and inventory management for kitchen.
Mapped to the Clipboard (📋) sidebar icon.
"""
...
class KDSCard(QFrame):
    ...
    def _setup_ui(self):
        ...
        line.setStyleSheet(f"background: {TEAL_PALE};")
        cv.addWidget(line)
...
class OrdersView(QWidget):
    """Kitchen Display System — Orders & History."""
    ...
    def _setup_ui(self):
        ...
        stock_btn.setStyleSheet(f"""
            ...
            QPushButton:hover {{ background: {TEAL_PALE}; color: {TEAL_DARK}; }}
        """)
    ...
    def refresh(self):
        ...
        if not orders:
            ...
            placeholder.setStyleSheet(
                f"color: {MUTED}; font-size: 16px; margin-top: 60px;"
            )
